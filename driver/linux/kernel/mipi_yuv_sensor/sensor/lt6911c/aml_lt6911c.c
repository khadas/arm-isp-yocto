...
static int lt6911c_probe(struct i2c_client *client, const struct i2c_device_id *id) {
...
static const struct i2c_device_id lt6911c_id[] = {
	{"lt6911c", 0},
	{},
};
MODULE_DEVICE_TABLE(i2c, lt6911c_id);
