...
#define OV16A1Q_SLAVE_ID     0x10
//0x530841

//#define OV16A1Q_HDR_30FPS_1440M
#define OV16A1Q_SDR_30FPS_756M
#define OV16A1Q_SDR_60FPS_1572M
#define OV16A1Q_SDR_120FPS_1572M
...
extern int ov16a1q_sensor_id(struct i2c_client *client);
extern int ov16a1q_power_on(struct device *dev, struct sensor_gpio *gpio);
extern int ov16a1q_power_off(struct device *dev, struct sensor_gpio *gpio);
extern int ov16a1q_power_suspend(struct device *dev);
extern int ov16a1q_power_resume(struct device *dev);
