...
#define IMX290_EXPOSURE_SHS1 IMX290_EXPOSURE
#define IMX290_EXPOSURE_SHS2 0x3024
...
// sdr 1080p 4-lanes 60fps 444.5M bps/lane, raw10
static const struct imx290_regval imx290_global_init_settings_60hz[] = {
	{0x3000, 0x01},
	{0x3002, 0x00},
	{0x3005, 0x00}, // adc raw10 0; raw12 1;
	{0x3007, 0x00},
	{0x3009, 0x01},
	{0x300a, 0x3c},
	{0x300f, 0x00},
	...
	{0x3016, 0x09},
	{0x3018, 0xDF},
	{0x3019, 0x04}, // VMAX 0x04df; hw reset value is 0x0456
	{0x301c, 0xEC},
	{0x301d, 0x07}, // HMAX 0x07ec; suggest 0x0898
	{0x3020, 0x02},
	{0x3021, 0x01},
	{0x3022, 0x00},
	{0x3046, 0x00},
	...
	{0x33b2, 0x1a},
	{0x33b3, 0x04},
	{0x3405, 0x10},// repetition bit[5:4] 1 for 445.5Mbps
	{0x3407, 0x03},
	{0x3414, 0x0a},
	{0x3415, 0x00},
	{0x3441, 0x0a},
	{0x3442, 0x0a}, // csi output 0x0a0a raw10;
	{0x3443, 0x03},
	{0x3444, 0x20},
	{0x3445, 0x25},
	{0x3446, 0x57},
...
// sdr 1080p  4 lanes 30fps 222.75M bps/lane, raw12
static const struct imx290_regval imx290_global_init_settings[] = {
	...
	{0x300B, 0x00},
	{0x300c, 0x00}, // normal mode; not DOL mode;
	{0x300F, 0x00},
	{0x3010, 0x21},
	{0x3012, 0x64},
	{0x3013, 0x00},
	...
	{0x3019, 0x04}, /* VMAX[15:8] */ // VMAX 0x0485 suggest 0x465
	{0x301a, 0x00}, /* VMAX[16] */
	{0x301b, 0x00},
	{0x301c, 0x30}, /* HMAX[7:0] */
	{0x301d, 0x11}, /* HMAX[15:8] */ // HMAX 0x1130
	{0x3020, 0x81}, // SHS1 0x0181
	{0x3021, 0x01},
	{0x3022, 0x00}, // SHS1
	{0x3024, 0x00}, // SHS2
	{0x3025, 0x00}, // SHS2
	...
	{0x3405, 0x20}, // repetition bit[5:4] 2 for 222.75Mbps
	{0x3407, 0x03},
	{0x3414, 0x0A},
	{0x3415, 0x01},
	{0x3418, 0x49},
	{0x3419, 0x04},
	{0x3441, 0x0C},
	{0x3442, 0x0C}, // csi output RAW12. 0x0c0c; raw10 0x0a0a
	{0x3443, 0x03},
...
// DOL 2 frame. 4 lanes 444.5Mbps/lane raw10 30fps.
static struct imx290_regval dol_1080p_30fps_4lane_10bits[] = {
	...
	{0x3009, 0x01},
	{0x300a, 0x3c},
	{0x300c, 0x11}, // DOL MODE; 2 frame DOL
	{0x300f, 0x00},
	{0x3010, 0x21},
	{0x3012, 0x64},
	{0x3014, 0x02},
	{0x3016, 0x09},
	{0x3018, 0xC4}, // VMAX change from 0x0465 to 0x04C4
	{0x3019, 0x04}, // VMAX

	{0x301c, 0xEC}, //* HMAX */ change from 0x0898 to 0x07EC before combination 60fps, after combination 30fps
	{0x301d, 0x07}, //* HMAX */
	{0x3020, 0x02}, // SHS1
	{0x3021, 0x00}, // SHS1 0x02
	{0x3022, 0x00}, // SHS1
	{0x3024, 0x53}, // SHS2
	{0x3025, 0x04}, // SHS2
	{0x3026, 0x00}, // SHS2 0x453
	{0x3030, 0xcd}, // RHS1
	{0x3031, 0x00}, // RHS1
	{0x3032, 0x00}, // RHS1 0xcd. not big than 2*(vmax-1109)-2
	{0x3045, 0x05}, // DOL
	...
	{0x3405, 0x10},  // repetition bit[5:4] 1 for 444.5Mbps sdr 60fps. wdr 30fps.
	{0x3407, 0x03},
	{0x3414, 0x0a},
	{0x3415, 0x00},

	{0x3441, 0x0a},
	{0x3442, 0x0a}, // csi output RAW12. 0x0c0c; raw10 0x0a0a
	{0x3443, 0x03},
	{0x3444, 0x20},
	{0x3445, 0x25},
	{0x3446, 0x57},
