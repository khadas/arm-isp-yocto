...
#define APP_NAME        "AML Online Tunning Tool"
#define APP_VENDOR      "AML"
#define APP_URL         "https://aml.com/"
...
void CACTServerApp::ShowApplicationTitle() {
    std::cout << APP_NAME << " " << __MODULE_VERSION << " (built: " << __DATE__ << " " << __TIME__ << ")" << std::endl;
}
