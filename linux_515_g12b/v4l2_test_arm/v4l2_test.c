...
int main(int argc, char *argv[])
{
    ...
    displaybuf_fr = (unsigned char *)malloc(tparam[ARM_V4L2_TEST_STREAM_FR].width * tparam[ARM_V4L2_TEST_STREAM_FR].height * 3);
#if ARM_V4L2_TEST_HAS_META
    displaybuf_meta = (unsigned char *)malloc(tparam[ARM_V4L2_TEST_STREAM_META].width * tparam[ARM_V4L2_TEST_STREAM_META].height * 3);
#endif
    displaybuf_ds1 = (unsigned char *)malloc(tparam[ARM_V4L2_TEST_STREAM_DS1].width * tparam[ARM_V4L2_TEST_STREAM_DS1].height * 3);
    displaybuf_ds2 = (unsigned char *)malloc(tparam[ARM_V4L2_TEST_STREAM_DS2].width * tparam[ARM_V4L2_TEST_STREAM_DS2].height * 3);
