...
typedef struct {
    ...
    int reg_wr_burst_lens;                      //u3: burst_lens limitation, burst_size: 0: 1x128, 1: 2x128, 2£þ3: 4x128
    ...
    int reg_rd_burst_lens  ;                //u3: burst_lens limitation, burst_size: 0: 1x128, 1: 2x128, 2£þ3: 4x128
	...
	int reg_md_input_ls;                //u4, E domain data left shift bit num to align with u20 Odomain data and will clip to u10 by dropping 10lsb, e.g. yuv is u12, then ls = 8;
