...
int param_md_init(T_MD_PRM *reg)
{
    ...
    reg->reg_wr_base_addr = 0x80000000; // u32:  wr axi base address
                                        ...
                                        // u9
    reg->reg_wr_burst_lens = 2;  // u3: burst_lens limitation, burst_size: 0: 1x128, 1: 2x128, 2��3: 4x128
    ...
    reg->reg_rd_base_addr = 0x80000000; // u32
                                        ...
                                        // u9
    reg->reg_rd_burst_lens = 2;  // u3: burst_lens limitation, burst_size: 0: 1x128, 1: 2x128, 2��3: 4x128
    ...
    reg->reg_md_input_ls = 0; // u4, E domain data left shift bit num to align with u20 Odomain data and will clip to u10 by dropping 10lsb, e.g. yuv is u12, then ls = 8;
                              // u20
                              // end
    ...
    // REG_NAME: MD_DS_STEP
    // u12
    reg->reg_ds_hstep = 3; // u4: integer pixel ratio for horizontal scalar, o2i_ratio= 1/step, 1��15
                           // u12
    reg->reg_ds_vstep = 3; // u4: integer pixel ratio for vertical scalar,   o2i_ratio= 1/step??1��15
                           // end
